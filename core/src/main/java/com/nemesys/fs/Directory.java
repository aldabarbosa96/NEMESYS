...
public final class Directory {
    ...
    /* getters */
    public Collection<Directory> getDirs()  { return subDirs.values(); }
    public Collection<VirtualFile> getFiles(){ return files.values(); }
    ...
    public Directory sub(String name) { return subDirs.get(name); }
    public VirtualFile file(String fullname) { return files.get(fullname); }
}
